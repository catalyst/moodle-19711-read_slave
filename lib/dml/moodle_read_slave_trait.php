    ...
    public function connect($dbhost, $dbuser, $dbpass, $dbname, $prefix, array $dboptions=null) {
        ...
        if ($dboptions) {
            if (isset($dboptions['dbhost_readonly'])) {
                ...
                if (isset($dboptions['dbport_readonly'])) {
                    $dboptions['dbport'] = $dboptions['dbport_readonly'];
                }
                if (!isset($dboptions['connecttimeout'])) {
                    $dboptions['connecttimeout'] = 2; // Default readonly connection timeout.
                }
                if (isset($dboptions['db_readonly_connecttimeout'])) {
                    $dboptions['connecttimeout'] = $dboptions['db_readonly_connecttimeout'];
                }
                try {
                    $this->_connect($ro, $dbuser, $dbpass, $dbname, $prefix, $dboptions);
