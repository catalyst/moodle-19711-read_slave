...
$observers = [
    ...
    [
        'eventname'   => '*',
        'callback'    => 'core_course\management\helper::observe_course_updated',
    ],
    [
        'eventname'   => '\core\event\course_backup_created',
        'callback'    => 'core_course\management\helper::observe_course_backup_created',
    ],
    [
        'eventname'   => '\core\event\course_restored',
        'callback'    => 'core_course\management\helper::observe_course_restored',
    ],
];
