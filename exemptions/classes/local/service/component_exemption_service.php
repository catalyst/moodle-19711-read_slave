...
/**
 * Class service, providing a single API for interacting with the exemptions subsystem, for all exemptions of a specific component.
...
class component_exemption_service {
     ...
     * Example usage:
     *
     * [$sql, $params] = $service->get_join_sql_by_type('core_message', 'message_conversations', 'myexemptiontablealias',
     *                                                      'conv.id');
     * Results in $sql:
